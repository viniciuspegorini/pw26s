...
insert into marca (nome) values ('Zarer');
insert into marca (nome) values ('Usas');
...
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('Kit Teclado e Mouse','Kit com teclado ABNT e mouse com 5 botões',199.0,1,2);
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('Smartphone XYZ','Smatphone com tela de 9pol, 12GB....',9999.0,5,1);
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('TV LCD 75pol','TV LCD 75pol, 5 HDMI...',7555.0,5,2);
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('Fogão 6 Bocas','Fogão 6 Bocas em aço inox, ...', 799.99,3,3);
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('Roteador Wi-Fi 5.4GhZ','Roteador Wi-Fi 5.4GhZ, 6 antenas...',1299.0,1,1);
